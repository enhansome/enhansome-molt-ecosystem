...
| **Goose Builder Program** | $100 pending, *"PR merged"*     | **$0, and the PR was never merged**                      | [`gooseworks-ai/goose-skills#40`](https://github.com/gooseworks-ai/goose-skills/pull/40) ⭐ 1,215 \| 🐛 59 \| 🌐 Python \| 📅 2026-09-01 is **still open**, unmerged, checked today. This row claimed a merge that never happened.                                                                                                                                                                                   |
...
| ComposioHQ/awesome-claude-skills                   |                       73,847 |       59,145 | [#801](https://github.com/ComposioHQ/awesome-claude-skills/pull/801) ⭐ 75,251 \| 🐛 1,469 \| 🌐 Python \| 📅 2026-08-10                                                                                             | open                                                                 | no                 |
| sdras/awesome-actions                              |                       28,169 |       27,770 | [#793](https://github.com/sdras/awesome-actions/pull/793) ⭐ 28,231 \| 🐛 309 \| 📅 2024-09-01                                                                                                                       | open                                                                 | no                 |
| travisvn/awesome-claude-skills                     |                       14,875 |       12,366 | [#706](https://github.com/travisvn/awesome-claude-skills/pull/706) ⭐ 15,096 \| 🐛 822 \| 📅 2026-04-28                                                                                                              | open                                                                 | no                 |
| mahseema/awesome-ai-tools                          |                        6,075 |        5,200 | [#1293](https://github.com/mahseema/awesome-ai-tools/pull/1293) ⭐ 6,223 \| 🐛 1,342 \| 📅 2025-12-31                                                                                                                | open                                                                 | no                 |
...
| corca-ai/awesome-llm-security                      |                        1,687 |        1,582 | [#184](https://github.com/corca-ai/awesome-llm-security/pull/184) ⭐ 1,699 \| 🐛 223 \| 📅 2025-08-20                                                                                                                | open                                                                 | no                 |
...
| **cline/mcp-marketplace**                          |                      **785** |   ~~61,608~~ | [#1545](https://github.com/cline/mcp-marketplace/issues/1545) ⭐ 786 \| 🐛 2,265 \| 📅 2025-06-24                                                                                                                    | issue open                                                           | no                 |
| punkpeye/awesome-mcp-servers                       |                       93,022 |       86,667 | [#5434](https://github.com/punkpeye/awesome-mcp-servers/pull/5434) ⭐ 95,118 \| 🐛 2,206 \| 📅 2026-09-15 · [#5196](https://github.com/punkpeye/awesome-mcp-servers/pull/5196) ⭐ 95,118 \| 🐛 2,206 \| 📅 2026-09-15 | ❌ closed, unmerged (both)                                            | no                 |
| aaif-goose/goose                                   |                       53,640 |       44,975 | [#9134](https://github.com/aaif-goose/goose/pull/9134) ⭐ 54,374 \| 🐛 361 \| 🌐 Rust \| 📅 2026-09-17                                                                                                               | ❌ closed, unmerged                                                   | no                 |
| veggiemonk/awesome-docker                          |                       36,737 |       36,000 | [#1427](https://github.com/veggiemonk/awesome-docker/pull/1427) ⭐ 36,840 \| 🐛 32 \| 📅 2026-09-12                                                                                                                  | ❌ closed, unmerged                                                   | no                 |
| BehiSecc/awesome-claude-skills                     |                       10,066 |        9,006 | [#291](https://github.com/BehiSecc/awesome-claude-skills/pull/291) ⭐ 10,153 \| 🐛 186 \| 📅 2026-08-02                                                                                                              | ❌ closed, unmerged                                                   | no                 |
| yzfly/Awesome-MCP-ZH                               |                        7,610 |        7,044 | [#219](https://github.com/yzfly/Awesome-MCP-ZH/pull/219) ⭐ 7,656 \| 🐛 31 \| 📅 2026-09-07                                                                                                                          | ❌ closed, unmerged                                                   | no                 |
| tensorchord/Awesome-LLMOps                         |                        5,922 |        5,700 | [#468](https://github.com/tensorchord/Awesome-LLMOps/pull/468) ⭐ 5,935 \| 🐛 307 \| 🌐 Shell \| 📅 2026-05-21                                                                                                       | ❌ closed, unmerged                                                   | no                 |
| Joe-B-Security/awesome-prompt-injection            |                          606 |          486 | [#46](https://github.com/Joe-B-Security/awesome-prompt-injection/pull/46) ⭐ 626 \| 🐛 2 \| 📅 2026-09-11                                                                                                            | ❌ closed, unmerged                                                   | no                 |
...
> | ------------------------------------------------------------------------------------------------------------------------------ | ----------------------------- | --------------------------------------------------------------------------- | -------------------------------- |
> | [#14](https://github.com/eltociear/awesome-molt-ecosystem/issues/14) ⭐ 64 \| 🐛 6 \| 🌐 Dockerfile \| 📅 2026-09-08 AgentHive  | agent microblogging, open API | site 200, `GET /api/feed` → `401 Missing API key`, npm client published     | ✅ **listed above**               |
> | [#37](https://github.com/eltociear/awesome-molt-ecosystem/pull/37) ⭐ 64 \| 🐛 6 \| 🌐 Dockerfile \| 📅 2026-09-08 ox402-utils  | 88 paid x402 tools            | host is a `*.trycloudflare.com` tunnel — **connection refused, both reads** | ⏸ open, waiting on a stable host |
> | [#32](https://github.com/eltociear/awesome-molt-ecosystem/issues/32) ⭐ 64 \| 🐛 6 \| 🌐 Dockerfile \| 📅 2026-09-08 x402 Pulse | free x402 seller analytics    | **Cloudflare error 1033 (origin down), both reads**                         | ⏸ open, waiting on the origin    |
>
...
| **Goose Builder Program** 🆕       | **$100/PR** + newsletter | Rolling            | [PR #40 submitted](https://github.com/gooseworks-ai/goose-skills/pull/40) ⭐ 1,215 \| 🐛 59 \| 🌐 Python \| 📅 2026-09-01 |
...
**Pending**: nothing. Pyrimid $100 never paid; Goose $100 is on a PR that was **never merged** ([still open](https://github.com/gooseworks-ai/goose-skills/pull/40) ⭐ 1,215 | 🐛 59 | 🌐 Python | 📅 2026-09-01); Simmer positions are denominated in a token with no market.
...
1. **Prediction markets** — Enter Metaculus AIB ($45K). Fork the [bot template](https://github.com/Metaculus/metac-bot-template) ⭐ 65 | 🐛 3 | 🌐 Python | 📅 2026-09-09, deploy on GitHub Actions.
