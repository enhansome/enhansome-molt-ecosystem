...
| **Goose Builder Program** | $100 pending, *"PR merged"*     | **$0, and the PR was never merged**                      | [`gooseworks-ai/goose-skills#40`](https://github.com/gooseworks-ai/goose-skills/pull/40) ⭐ 1,219 \| 🐛 59 \| 🌐 Python \| 📅 2026-09-01 is **still open**, unmerged, checked today. This row claimed a merge that never happened.                                                                                                                                                                                   |
...
| -------------------------------------------------- | ---------------------------: | -----------: | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------- | ------------------ |
| **bureado/awesome-software-supply-chain-security** |                          379 |          358 | [#61](https://github.com/bureado/awesome-software-supply-chain-security/pull/61) ⭐ 380 \| 🐛 53 \| 📅 2026-06-07                                                                                                    | ✅ **merged 2026-06-06**                                              | ✅ **yes**          |
| ComposioHQ/awesome-claude-skills                   |                       73,847 |       59,145 | [#801](https://github.com/ComposioHQ/awesome-claude-skills/pull/801) ⭐ 75,365 \| 🐛 1,486 \| 🌐 Python \| 📅 2026-09-18                                                                                             | open                                                                 | no                 |
| sdras/awesome-actions                              |                       28,169 |       27,770 | [#793](https://github.com/sdras/awesome-actions/pull/793) ⭐ 28,240 \| 🐛 312 \| 📅 2024-09-01                                                                                                                       | open                                                                 | no                 |
| travisvn/awesome-claude-skills                     |                       14,875 |       12,366 | [#706](https://github.com/travisvn/awesome-claude-skills/pull/706) ⭐ 15,114 \| 🐛 830 \| 📅 2026-04-28                                                                                                              | open                                                                 | no                 |
| mahseema/awesome-ai-tools                          |                        6,075 |        5,200 | [#1293](https://github.com/mahseema/awesome-ai-tools/pull/1293) ⭐ 6,245 \| 🐛 1,358 \| 📅 2025-12-31                                                                                                                | open                                                                 | no                 |
| devsecops/awesome-devsecops                        |                        5,460 |        5,400 | [#134](https://github.com/devsecops/awesome-devsecops/pull/134) ⭐ 5,477 \| 🐛 90 \| 📅 2024-05-11                                                                                                                   | open                                                                 | no                 |
| corca-ai/awesome-llm-security                      |                        1,687 |        1,582 | [#184](https://github.com/corca-ai/awesome-llm-security/pull/184) ⭐ 1,701 \| 🐛 226 \| 📅 2025-08-20                                                                                                                | open                                                                 | no                 |
...
| **cline/mcp-marketplace**                          |                      **785** |   ~~61,608~~ | [#1545](https://github.com/cline/mcp-marketplace/issues/1545) ⭐ 788 \| 🐛 2,290 \| 📅 2025-06-24                                                                                                                    | issue open                                                           | no                 |
| punkpeye/awesome-mcp-servers                       |                       93,022 |       86,667 | [#5434](https://github.com/punkpeye/awesome-mcp-servers/pull/5434) ⭐ 95,310 \| 🐛 2,332 \| 📅 2026-09-15 · [#5196](https://github.com/punkpeye/awesome-mcp-servers/pull/5196) ⭐ 95,310 \| 🐛 2,332 \| 📅 2026-09-15 | ❌ closed, unmerged (both)                                            | no                 |
| aaif-goose/goose                                   |                       53,640 |       44,975 | [#9134](https://github.com/aaif-goose/goose/pull/9134) ⭐ 54,489 \| 🐛 396 \| 🌐 Rust \| 📅 2026-09-19                                                                                                               | ❌ closed, unmerged                                                   | no                 |
| veggiemonk/awesome-docker                          |                       36,737 |       36,000 | [#1427](https://github.com/veggiemonk/awesome-docker/pull/1427) ⭐ 36,853 \| 🐛 37 \| 📅 2026-09-12                                                                                                                  | ❌ closed, unmerged                                                   | no                 |
| BehiSecc/awesome-claude-skills                     |                       10,066 |        9,006 | [#291](https://github.com/BehiSecc/awesome-claude-skills/pull/291) ⭐ 10,156 \| 🐛 195 \| 📅 2026-08-02                                                                                                              | ❌ closed, unmerged                                                   | no                 |
| yzfly/Awesome-MCP-ZH                               |                        7,610 |        7,044 | [#219](https://github.com/yzfly/Awesome-MCP-ZH/pull/219) ⭐ 7,666 \| 🐛 41 \| 📅 2026-09-07                                                                                                                          | ❌ closed, unmerged                                                   | no                 |
| tensorchord/Awesome-LLMOps                         |                        5,922 |        5,700 | [#468](https://github.com/tensorchord/Awesome-LLMOps/pull/468) ⭐ 5,941 \| 🐛 317 \| 🌐 Shell \| 📅 2026-05-21                                                                                                       | ❌ closed, unmerged                                                   | no                 |
| Joe-B-Security/awesome-prompt-injection            |                          606 |          486 | [#46](https://github.com/Joe-B-Security/awesome-prompt-injection/pull/46) ⭐ 629 \| 🐛 5 \| 📅 2026-09-11                                                                                                            | ❌ closed, unmerged                                                   | no                 |
...
| **Goose Builder Program** 🆕       | **$100/PR** + newsletter | Rolling            | [PR #40 submitted](https://github.com/gooseworks-ai/goose-skills/pull/40) ⭐ 1,219 \| 🐛 59 \| 🌐 Python \| 📅 2026-09-01 |
...
**Pending**: nothing. Pyrimid $100 never paid; Goose $100 is on a PR that was **never merged** ([still open](https://github.com/gooseworks-ai/goose-skills/pull/40) ⭐ 1,219 | 🐛 59 | 🌐 Python | 📅 2026-09-01); Simmer positions are denominated in a token with no market.
