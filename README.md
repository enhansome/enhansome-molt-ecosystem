...
| **Goose Builder Program** | $100 pending, *"PR merged"*     | **$0, and the PR was never merged**                      | [`gooseworks-ai/goose-skills#40`](https://github.com/gooseworks-ai/goose-skills/pull/40) ⭐ 1,223 \| 🐛 59 \| 🌐 Python \| 📅 2026-09-25 is **still open**, unmerged, checked today. This row claimed a merge that never happened.                                                                                                                                                                                   |
...
| -------------------------------------------------- | ---------------------------: | -----------: | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------- | ------------------ |
| **bureado/awesome-software-supply-chain-security** |                          379 |          358 | [#61](https://github.com/bureado/awesome-software-supply-chain-security/pull/61) ⭐ 380 \| 🐛 59 \| 📅 2026-06-07                                                                                                    | ✅ **merged 2026-06-06**                                              | ✅ **yes**          |
| ComposioHQ/awesome-claude-skills                   |                       73,847 |       59,145 | [#801](https://github.com/ComposioHQ/awesome-claude-skills/pull/801) ⭐ 75,611 \| 🐛 1,524 \| 🌐 Python \| 📅 2026-09-18                                                                                             | open                                                                 | no                 |
| sdras/awesome-actions                              |                       28,169 |       27,770 | [#793](https://github.com/sdras/awesome-actions/pull/793) ⭐ 28,249 \| 🐛 318 \| 📅 2024-09-01                                                                                                                       | open                                                                 | no                 |
| travisvn/awesome-claude-skills                     |                       14,875 |       12,366 | [#706](https://github.com/travisvn/awesome-claude-skills/pull/706) ⭐ 15,170 \| 🐛 839 \| 📅 2026-04-28                                                                                                              | open                                                                 | no                 |
| mahseema/awesome-ai-tools                          |                        6,075 |        5,200 | [#1293](https://github.com/mahseema/awesome-ai-tools/pull/1293) ⭐ 6,275 \| 🐛 1,370 \| 📅 2025-12-31                                                                                                                | open                                                                 | no                 |
| devsecops/awesome-devsecops                        |                        5,460 |        5,400 | [#134](https://github.com/devsecops/awesome-devsecops/pull/134) ⭐ 5,476 \| 🐛 91 \| 📅 2024-05-11                                                                                                                   | open                                                                 | no                 |
...
| **cline/mcp-marketplace**                          |                      **785** |   ~~61,608~~ | [#1545](https://github.com/cline/mcp-marketplace/issues/1545) ⭐ 787 \| 🐛 2,330 \| 📅 2025-06-24                                                                                                                    | issue open                                                           | no                 |
| punkpeye/awesome-mcp-servers                       |                       93,022 |       86,667 | [#5434](https://github.com/punkpeye/awesome-mcp-servers/pull/5434) ⭐ 95,504 \| 🐛 2,358 \| 📅 2026-09-23 · [#5196](https://github.com/punkpeye/awesome-mcp-servers/pull/5196) ⭐ 95,504 \| 🐛 2,358 \| 📅 2026-09-23 | ❌ closed, unmerged (both)                                            | no                 |
| aaif-goose/goose                                   |                       53,640 |       44,975 | [#9134](https://github.com/aaif-goose/goose/pull/9134) ⭐ 54,635 \| 🐛 417 \| 🌐 Rust \| 📅 2026-09-25                                                                                                               | ❌ closed, unmerged                                                   | no                 |
| veggiemonk/awesome-docker                          |                       36,737 |       36,000 | [#1427](https://github.com/veggiemonk/awesome-docker/pull/1427) ⭐ 36,885 \| 🐛 38 \| 📅 2026-09-12                                                                                                                  | ❌ closed, unmerged                                                   | no                 |
| BehiSecc/awesome-claude-skills                     |                       10,066 |        9,006 | [#291](https://github.com/BehiSecc/awesome-claude-skills/pull/291) ⭐ 10,179 \| 🐛 230 \| 📅 2026-09-21                                                                                                              | ❌ closed, unmerged                                                   | no                 |
| yzfly/Awesome-MCP-ZH                               |                        7,610 |        7,044 | [#219](https://github.com/yzfly/Awesome-MCP-ZH/pull/219) ⭐ 7,684 \| 🐛 31 \| 📅 2026-09-20                                                                                                                          | ❌ closed, unmerged                                                   | no                 |
| tensorchord/Awesome-LLMOps                         |                        5,922 |        5,700 | [#468](https://github.com/tensorchord/Awesome-LLMOps/pull/468) ⭐ 5,948 \| 🐛 325 \| 🌐 Shell \| 📅 2026-05-21                                                                                                       | ❌ closed, unmerged                                                   | no                 |
| Joe-B-Security/awesome-prompt-injection            |                          606 |          486 | [#46](https://github.com/Joe-B-Security/awesome-prompt-injection/pull/46) ⭐ 646 \| 🐛 11 \| 📅 2026-09-11                                                                                                           | ❌ closed, unmerged                                                   | no                 |
...
| **Goose Builder Program** 🆕       | **$100/PR** + newsletter | Rolling            | [PR #40 submitted](https://github.com/gooseworks-ai/goose-skills/pull/40) ⭐ 1,223 \| 🐛 59 \| 🌐 Python \| 📅 2026-09-25 |
...
**Pending**: nothing. Pyrimid $100 never paid; Goose $100 is on a PR that was **never merged** ([still open](https://github.com/gooseworks-ai/goose-skills/pull/40) ⭐ 1,223 | 🐛 59 | 🌐 Python | 📅 2026-09-25); Simmer positions are denominated in a token with no market.
