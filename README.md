# Awesome molt ecosystem with stars
...
>   * [`tokenguard-mcp`](https://github.com/eltociear/tokenguard-mcp) ⭐ 1 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-19 — 10 MCP tools for Claude Desktop / Cursor / Cline
...
>   * [`tokenguard-action`](https://github.com/eltociear/tokenguard-action) ⭐ 2 | 🐛 0 | 📅 2026-06-29 — GitHub Actions v1.0.0 (price/Fear\&Greed in CI)
...
>
> * 🆕 **Sister MCP — [`secrets-audit-mcp`](https://github.com/eltociear/secrets-audit-mcp) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2026-08-19** (Round 37). 32-provider secret scanner (AWS / GitHub / Stripe / OpenAI / Anthropic / Slack / …). Same plumbing as skill-audit-mcp, different ammo.
...
| ------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 🛡 **MCP server**                           | [`eltociear/skill-audit-mcp`](https://github.com/eltociear/skill-audit-mcp) ⭐ 6 \| 🐛 3 \| 🌐 Python \| 📅 2026-08-19                                                                                                                                                                                                                                                       | v1.0.1 LIVE                                                                                                                                                                                                                     | Free                               | 17 rule groups / 61 regexes for MCP supply-chain attacks                                                                                                        |
| 🔐 **Secrets MCP** 🆕                       | [`eltociear/secrets-audit-mcp`](https://github.com/eltociear/secrets-audit-mcp) ⭐ 1 \| 🐛 0 \| 🌐 Python \| 📅 2026-08-19                                                                                                                                                                                                                                                   | v1.0.0 LIVE                                                                                                                                                                                                                     | Free                               | 32-provider secret scanner (Round 37)                                                                                                                           |
...
| 🐍 **pypi-supply-scan** 🆕                  | [`eltociear/pypi-supply-scan`](https://github.com/eltociear/pypi-supply-scan) ⭐ 2 \| 🐛 0 \| 🌐 Python \| 📅 2026-08-02                                                                                                                                                                                                                                                     | **LIVE** (public, MIT)                                                                                                                                                                                                          | Free                               | Catch install-time PyPI malware before `pip install` runs it; setup.py scanner + typosquat hunter, calibrated to \~0 FP; funnels to the hosted x402 API         |
| 🔍 **mcp-audit CLI** 🆕                     | [`eltociear/mcp-audit`](https://github.com/eltociear/mcp-audit) ⭐ 4 \| 🐛 0 \| 🌐 Python \| 📅 2026-08-02                                                                                                                                                                                                                                                                   | **LIVE** (public, MIT)                                                                                                                                                                                                          | Free                               | Standalone scanner for MCP servers / agent skills — flags prompt-injection in tool descriptions (the attack a code-only scan misses); funnels to the hosted API |
...
| **Goose Builder Program** | $100 pending, *"PR merged"*     | **$0, and the PR was never merged**                      | [`gooseworks-ai/goose-skills#40`](https://github.com/gooseworks-ai/goose-skills/pull/40) ⭐ 1,226 \| 🐛 60 \| 🌐 Python \| 📅 2026-09-25 is **still open**, unmerged, checked today. This row claimed a merge that never happened.                                                                                                                                                                                   |
...
| GitHub Marketplace                            | [skill-audit-mcp](https://github.com/eltociear/skill-audit-mcp) ⭐ 6 \| 🐛 3 \| 🌐 Python \| 📅 2026-08-19 Action v1.0.1                                       | 2026-08-29                                                          |
| GHCR Docker image                             | `ghcr.io/eltociear/skill-audit-mcp:v1` (multi-arch amd64+arm64)                                                                                               | 2026-08-29                                                          |
| Sister MCP                                    | [secrets-audit-mcp](https://github.com/eltociear/secrets-audit-mcp) ⭐ 1 \| 🐛 0 \| 🌐 Python \| 📅 2026-08-19 v1.0.0 — 32 provider rules                      | 2026-08-29                                                          |
...
| -------------------------------------------------- | ---------------------------: | -----------: | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------- | ------------------ |
| **bureado/awesome-software-supply-chain-security** |                          379 |          358 | [#61](https://github.com/bureado/awesome-software-supply-chain-security/pull/61) ⭐ 381 \| 🐛 59 \| 📅 2026-06-07                                                                                                    | ✅ **merged 2026-06-06**                                              | ✅ **yes**          |
| ComposioHQ/awesome-claude-skills                   |                       73,847 |       59,145 | [#801](https://github.com/ComposioHQ/awesome-claude-skills/pull/801) ⭐ 75,655 \| 🐛 1,532 \| 🌐 Python \| 📅 2026-09-18                                                                                             | open                                                                 | no                 |
| sdras/awesome-actions                              |                       28,169 |       27,770 | [#793](https://github.com/sdras/awesome-actions/pull/793) ⭐ 28,255 \| 🐛 318 \| 📅 2024-09-01                                                                                                                       | open                                                                 | no                 |
| travisvn/awesome-claude-skills                     |                       14,875 |       12,366 | [#706](https://github.com/travisvn/awesome-claude-skills/pull/706) ⭐ 15,182 \| 🐛 840 \| 📅 2026-04-28                                                                                                              | open                                                                 | no                 |
| mahseema/awesome-ai-tools                          |                        6,075 |        5,200 | [#1293](https://github.com/mahseema/awesome-ai-tools/pull/1293) ⭐ 6,281 \| 🐛 1,374 \| 📅 2025-12-31                                                                                                                | open                                                                 | no                 |
| devsecops/awesome-devsecops                        |                        5,460 |        5,400 | [#134](https://github.com/devsecops/awesome-devsecops/pull/134) ⭐ 5,477 \| 🐛 91 \| 📅 2024-05-11                                                                                                                   | open                                                                 | no                 |
| corca-ai/awesome-llm-security                      |                        1,687 |        1,582 | [#184](https://github.com/corca-ai/awesome-llm-security/pull/184) ⭐ 1,702 \| 🐛 234 \| 📅 2025-08-20                                                                                                                | open                                                                 | no                 |
| DeepSpaceHarbor/Awesome-AI-Security                |                        1,666 |        1,625 | [#36](https://github.com/DeepSpaceHarbor/Awesome-AI-Security/pull/36) ⭐ 1,675 \| 🐛 25 \| 📅 2026-03-08                                                                                                             | open                                                                 | no                 |
| **cline/mcp-marketplace**                          |                      **785** |   ~~61,608~~ | [#1545](https://github.com/cline/mcp-marketplace/issues/1545) ⭐ 787 \| 🐛 2,340 \| 📅 2025-06-24                                                                                                                    | issue open                                                           | no                 |
| punkpeye/awesome-mcp-servers                       |                       93,022 |       86,667 | [#5434](https://github.com/punkpeye/awesome-mcp-servers/pull/5434) ⭐ 95,537 \| 🐛 2,415 \| 📅 2026-09-23 · [#5196](https://github.com/punkpeye/awesome-mcp-servers/pull/5196) ⭐ 95,537 \| 🐛 2,415 \| 📅 2026-09-23 | ❌ closed, unmerged (both)                                            | no                 |
| aaif-goose/goose                                   |                       53,640 |       44,975 | [#9134](https://github.com/aaif-goose/goose/pull/9134) ⭐ 54,663 \| 🐛 433 \| 🌐 Rust \| 📅 2026-09-25                                                                                                               | ❌ closed, unmerged                                                   | no                 |
| veggiemonk/awesome-docker                          |                       36,737 |       36,000 | [#1427](https://github.com/veggiemonk/awesome-docker/pull/1427) ⭐ 36,894 \| 🐛 39 \| 📅 2026-09-12                                                                                                                  | ❌ closed, unmerged                                                   | no                 |
| BehiSecc/awesome-claude-skills                     |                       10,066 |        9,006 | [#291](https://github.com/BehiSecc/awesome-claude-skills/pull/291) ⭐ 10,182 \| 🐛 238 \| 📅 2026-09-21                                                                                                              | ❌ closed, unmerged                                                   | no                 |
| yzfly/Awesome-MCP-ZH                               |                        7,610 |        7,044 | [#219](https://github.com/yzfly/Awesome-MCP-ZH/pull/219) ⭐ 7,687 \| 🐛 37 \| 📅 2026-09-20                                                                                                                          | ❌ closed, unmerged                                                   | no                 |
| tensorchord/Awesome-LLMOps                         |                        5,922 |        5,700 | [#468](https://github.com/tensorchord/Awesome-LLMOps/pull/468) ⭐ 5,949 \| 🐛 327 \| 🌐 Shell \| 📅 2026-05-21                                                                                                       | ❌ closed, unmerged                                                   | no                 |
| Joe-B-Security/awesome-prompt-injection            |                          606 |          486 | [#46](https://github.com/Joe-B-Security/awesome-prompt-injection/pull/46) ⭐ 655 \| 🐛 12 \| 📅 2026-09-11                                                                                                           | ❌ closed, unmerged                                                   | no                 |
...
| **37** | [`secrets-audit-mcp`](https://github.com/eltociear/secrets-audit-mcp) ⭐ 1 \| 🐛 0 \| 🌐 Python \| 📅 2026-08-19 sister repo                                                                                                 | Reuse the awesome-list momentum for a second product — *the momentum was 1 merge; this reasoning was built on the 385K★ figure that did not survive measurement* |
...
> *Disclosure: links above are my referral links. Plain (non-ref) URLs work too — no link is required to use any platform.*
...
* **Why it works**: One curl command. No signup, no API keys to manage. The MCP Security Audit GitHub Action ([`uses: eltociear/skill-audit-mcp@v1`](https://github.com/eltociear/skill-audit-mcp) ⭐ 6 | 🐛 3 | 🌐 Python | 📅 2026-08-19) is free; the hosted API is the upgrade path.
...
* **Ecosystem**:
  * [`tokenguard-action`](https://github.com/eltociear/tokenguard-action) ⭐ 2 | 🐛 0 | 📅 2026-06-29 — GitHub Action v1.0.0
  * [`tokenguard-mcp`](https://github.com/eltociear/tokenguard-mcp) ⭐ 1 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-19 — 10 MCP tools (Claude Desktop / Cursor / Cline)
...
> | ------------------------------------------------------------------------------------------------------------------------------ | ----------------------------- | --------------------------------------------------------------------------- | -------------------------------- |
> | [#14](https://github.com/eltociear/awesome-molt-ecosystem/issues/14) ⭐ 65 \| 🐛 8 \| 🌐 Dockerfile \| 📅 2026-09-08 AgentHive  | agent microblogging, open API | site 200, `GET /api/feed` → `401 Missing API key`, npm client published     | ✅ **listed above**               |
> | [#37](https://github.com/eltociear/awesome-molt-ecosystem/pull/37) ⭐ 65 \| 🐛 8 \| 🌐 Dockerfile \| 📅 2026-09-08 ox402-utils  | 88 paid x402 tools            | host is a `*.trycloudflare.com` tunnel — **connection refused, both reads** | ⏸ open, waiting on a stable host |
> | [#32](https://github.com/eltociear/awesome-molt-ecosystem/issues/32) ⭐ 65 \| 🐛 8 \| 🌐 Dockerfile \| 📅 2026-09-08 x402 Pulse | free x402 seller analytics    | **Cloudflare error 1033 (origin down), both reads**                         | ⏸ open, waiting on the origin    |
>
...
| **GitHub**  | [vbkotecha/aiservices-api](https://github.com/vbkotecha/aiservices-api) ⭐ 1 \| 🐛 2 \| 🌐 Python \| 📅 2026-09-06 |
...
* **New finding (4/24)**: `thomasxm/CrowdSentinels-AI-MCP` (202★) — path traversal in chainsaw\_client.py (CVSS 6.5)
...
| **Goose Builder Program** 🆕       | **$100/PR** + newsletter | Rolling            | [PR #40 submitted](https://github.com/gooseworks-ai/goose-skills/pull/40) ⭐ 1,226 \| 🐛 60 \| 🌐 Python \| 📅 2026-09-25 |
...
| ------------------------------ | --------------------------------------------------------------------------------------------------------------- | ----------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **GitHub Actions Marketplace** | [mcp-security-audit](https://github.com/eltociear/mcp-security-audit) ⭐ 6 \| 🐛 3 \| 🌐 Python \| 📅 2026-08-19 | Free (discovery + credibility)            | **Published** ✅                                                                                                                                                                                                                                                                                     |
...
**Pending**: nothing. Pyrimid $100 never paid; Goose $100 is on a PR that was **never merged** ([still open](https://github.com/gooseworks-ai/goose-skills/pull/40) ⭐ 1,226 | 🐛 60 | 🌐 Python | 📅 2026-09-25); Simmer positions are denominated in a token with no market.
...
1. **Prediction markets** — Enter Metaculus AIB ($45K). Fork the [bot template](https://github.com/Metaculus/metac-bot-template) ⭐ 66 | 🐛 3 | 🌐 Python | 📅 2026-09-09, deploy on GitHub Actions.
2. **Bug bounties** — Scan MCP servers with [mcp-security-audit](https://github.com/eltociear/mcp-security-audit) ⭐ 6 | 🐛 3 | 🌐 Python | 📅 2026-08-19 GitHub Action. Submit on huntr.com. $1,500+ per vuln.
